...
export default function Home() {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-black text-stone-50">
      ...
      <nav className="sticky top-0 z-40 border-b border-gold/15 bg-black/72 px-4 py-3 backdrop-blur-xl sm:px-8">
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-3">
          ...
          <div className="flex gap-2 overflow-x-auto text-[0.68rem] font-black uppercase tracking-[0.14em] text-stone-200/80">
            <a className="nav-pill" href="#booking">Book</a><a className="nav-pill" href="#priser">Priser</a><a className="nav-pill" href="#admin">Backend</a>
          </div>
        </div>
      </nav>
      ...
      <section id="admin" className="px-5 py-10 sm:px-8 lg:px-12"><div className="mx-auto max-w-7xl"><div className="mb-8 flex flex-col justify-between gap-4 lg:flex-row lg:items-end"><div><p className="eyebrow">Åben backend</p><h2 className="mt-2 text-3xl font-semibold uppercase tracking-[0.18em] text-gold sm:text-5xl">Order Operations</h2><p className="mt-3 max-w-3xl text-stone-300/75">Ordresystemet er udvidet med pipeline, kalender, kundeliste, fuld redigering og backup/import.</p></div><a href="#booking" className="gold-button">Ny ordre</a></div>
